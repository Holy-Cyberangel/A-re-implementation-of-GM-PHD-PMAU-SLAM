...
static emlrtRSInfo b_emlrtRSI = {
    ...
    "version\\codes\\LGM-PHD-PMAU-SLAM-MEX\\tools\\slam_step_c"
    "odegen.m" /* pathName */
};
            ...
            emxArray_struct0_T *mapOut)
{
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if (b_i + 1 > mapOut->size[1]) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, mapOut->size[1], &sd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  for (j = 0; j < i1; j++) {
    if (j + 1 > birthIdx_size[1]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, birthIdx_size[1], &td_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (birthIdx_data[j]) {
      __m128d r;
      ...
      outCount++;
      if (j + 1 > i1) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, i1, &od_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      ...
      Jx[2] = 0.0;
      if (j + 1 > i1) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, i1, &ud_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      Jx[4] = Jx_tmp * S_tmp - d;
      Jx[1] = 0.0;
  ...
  if (outCount == 0) {
    ...
    emxEnsureCapacity_struct0_T(&st, mapOut, i, &fb_emlrtRTEI);
  }
}
                               ...
                               const real_T Z[2], real_T S[4])
{
  ...
  b_value = muDoubleScalarAbs(S[1]);
  d = muDoubleScalarAbs(S[0]);
  if (b_value > d) {
    r1 = 1;
    r2 = 0;
  } else {
  ...
  return 1.0 / (6.2831853071795862 * muDoubleScalarSqrt(b_value)) *
    ...
    boolean_T birthIdx_data[], int32_T birthIdx_size[2])
{
  ...
  emxArray_real_T *mStore;
  emxArray_struct0_T *b_mapOut;
  struct0_T *b_mapOut_data;
  struct0_T *mapOut_data;
  real_T bestWPerLandmark_data[512];
  ...
  emxInit_struct0_T(sp, &b_mapOut, &r_emlrtRTEI);
  st.site = &mc_emlrtRSI;
  repmat(
      &st,
  ...
  r2 = mapOut->size[0] * mapOut->size[1];
  mapOut->size[0] = 1;
  r1 = b_mapOut->size[1];
  mapOut->size[1] = b_mapOut->size[1];
  emxEnsureCapacity_struct0_T(sp, mapOut, r2, &l_emlrtRTEI);
  ...
  for (i = 0; i < r1; i++) {
    if (i + 1 > r1) {
      emlrtDynamicBoundsCheckR2012b(i + 1, 1, r1, &hb_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (i + 1 > mapOut->size[1]) {
      emlrtDynamicBoundsCheckR2012b(i + 1, 1, mapOut->size[1], &ib_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  if (inMap_size[1] == 0) {
    ...
    if (outCount == 0) {
      ...
      r2 = b_mapOut->size[0] * b_mapOut->size[1];
      b_mapOut->size[0] = 1;
      b_mapOut->size[1] = outCount;
      emxEnsureCapacity_struct0_T(&st, b_mapOut, r2, &i_emlrtRTEI);
      mapOut_data = b_mapOut->data;
    ...
    r1 = b_mapOut->size[1];
    mapOut->size[1] = b_mapOut->size[1];
    emxEnsureCapacity_struct0_T(sp, mapOut, r2, &m_emlrtRTEI);
    b_mapOut_data = mapOut->data;
    for (i = 0; i < r1; i++) {
      b_mapOut_data[i] = mapOut_data[i];
    }
    ...
    int32_T idx;
    int32_T maxComp;
    int32_T rawLike_i_size_idx_1;
    int16_T parentIdx_data[24576];
    int8_T measIdx_data[24576];
    /*  ===== transform measurements to world ===== */
    a21 = muDoubleScalarSin(-x[2]);
    S_tmp = muDoubleScalarCos(-x[2]);
    rot[0] = S_tmp;
    rot[2] = a21;
    rot[1] = -a21;
    rot[3] = S_tmp;
    ...
    for (j = 0; j < loop_ub; j++) {
      ...
      missW = Z_data[r2];
      detDen = a21 * missW;
      Zmap_data[2 * j] = x[0] + (S_tmp * a22 + detDen);
      missW *= S_tmp;
      Zmap_data[r2] = x[1] + (-a21 * a22 + missW);
      if (j + 1 > loop_ub) {
      ...
      Jx[4] = a22 * a21 - missW;
      if (j + 1 > loop_ub) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, loop_ub, &kb_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      Jx[5] = a22 * S_tmp + detDen;
      if (j + 1 > RstackLocal_size[2]) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, RstackLocal_size[2],
    ...
    for (i = 0; i < numIn; i++) {
      if (i + 1 > numIn) {
        emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &lb_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      ...
      if (missW > params_map_miss_prune_threshold) {
        ...
        if (i + 1 > numIn) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &ec_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
    ...
    /*  ========================================================= */
    maxComp = inMap_size[1] * Z_size[1];
    emxInit_real_T(sp, &mStore, 2, &n_emlrtRTEI);
    r2 = mStore->size[0] * mStore->size[1];
    mStore->size[0] = 2;
    mStore->size[1] = maxComp;
    emxEnsureCapacity_real_T(sp, mStore, r2, &n_emlrtRTEI);
    mStore_data = mStore->data;
    r1 = maxComp << 1;
    for (i = 0; i < r1; i++) {
      mStore_data[i] = 0.0;
    }
    emxInit_real_T(sp, &PStore, 3, &o_emlrtRTEI);
    r2 = PStore->size[0] * PStore->size[1] * PStore->size[2];
    PStore->size[0] = 2;
    PStore->size[1] = 2;
    PStore->size[2] = maxComp;
    emxEnsureCapacity_real_T(sp, PStore, r2, &o_emlrtRTEI);
    PStore_data = PStore->data;
    r1 = maxComp << 2;
    for (i = 0; i < r1; i++) {
      PStore_data[i] = 0.0;
    }
    emxInit_real_T(sp, &WStore, 2, &p_emlrtRTEI);
    r2 = WStore->size[0] * WStore->size[1];
    WStore->size[0] = 1;
    WStore->size[1] = maxComp;
    emxEnsureCapacity_real_T(sp, WStore, r2, &p_emlrtRTEI);
    ...
    for (j = 0; j < loop_ub; j++) {
      ...
      for (i = 0; i < numIn; i++) {
        ...
        if (j + 1 > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, loop_ub, &q_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        r = _mm_loadu_pd(&Rworld_data[4 * j]);
        _mm_storeu_pd(&K[0], _mm_add_pd(_mm_loadu_pd(&inMap_data[i].P[0]), r));
        r = _mm_loadu_pd(&Rworld_data[4 * j + 2]);
        _mm_storeu_pd(&K[2], _mm_add_pd(_mm_loadu_pd(&inMap_data[i].P[2]), r));
        if (i + 1 > numIn) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &nb_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        st.site = &pc_emlrtRSI;
        missW = likelihood_local(&st, inMap_data[i].m, &Zmap_data[2 * j], K) *
      ...
      if (detDen > 0.0) {
        for (i = 0; i < numIn; i++) {
          if (i + 1 > numIn) {
            emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &ob_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          missW = rawLike_i_data[i] / detDen;
          if (missW > c_params_map_detection_add_thre) {
            if (i + 1 > numIn) {
              emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &r_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (j + 1 > loop_ub) {
              emlrtDynamicBoundsCheckR2012b(j + 1, 1, loop_ub, &s_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            r = _mm_loadu_pd(&Rworld_data[4 * j]);
            _mm_storeu_pd(&rot[0],
            ...
            st.site = &qc_emlrtRSI;
            if (i + 1 > numIn) {
              emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &t_emlrtBCI, &st);
            }
            b_st.site = &ib_emlrtRSI;
            c_st.site = &jb_emlrtRSI;
            d_st.site = &kb_emlrtRSI;
            ...
            rawLike_i_size_idx_1 = r1 << 1;
            _mm_storeu_pd(&K[rawLike_i_size_idx_1],
                          _mm_div_pd(_mm_loadu_pd(&inMap_data[i].P[0]),
                                     _mm_set1_pd(rot[r1])));
            r = _mm_loadu_pd(&K[rawLike_i_size_idx_1]);
            r1 = r2 << 1;
            _mm_storeu_pd(
                &K[r1],
                _mm_div_pd(_mm_sub_pd(_mm_loadu_pd(&inMap_data[i].P[2]),
                                      _mm_mul_pd(r, _mm_set1_pd(S_tmp))),
                           _mm_set1_pd(a22)));
            r = _mm_loadu_pd(&K[r1]);
            b_r1 = _mm_loadu_pd(&K[rawLike_i_size_idx_1]);
            _mm_storeu_pd(&K[rawLike_i_size_idx_1],
                          _mm_sub_pd(b_r1, _mm_mul_pd(r, _mm_set1_pd(a21))));
            if (j + 1 > loop_ub) {
              emlrtDynamicBoundsCheckR2012b(j + 1, 1, loop_ub, &v_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (i + 1 > numIn) {
              emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &u_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            idx++;
            r = _mm_loadu_pd(&Zmap_data[2 * j]);
            _mm_storeu_pd(&Zmap[0],
                          _mm_sub_pd(r, _mm_loadu_pd(&inMap_data[i].m[0])));
            if (idx > mStore->size[1]) {
              emlrtDynamicBoundsCheckR2012b(idx, 1, mStore->size[1],
                                            &ab_emlrtBCI, (emlrtConstCTX)sp);
            }
            if (i + 1 > numIn) {
              emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &cc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            r1 = 2 * (idx - 1);
            mStore_data[r1] =
                inMap_data[i].m[0] + (K[0] * Zmap[0] + Zmap[1] * K[2]);
            if (i + 1 > numIn) {
              emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &cc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            mStore_data[r1 + 1] =
                inMap_data[i].m[1] + (Zmap[0] * K[1] + Zmap[1] * K[3]);
            rot[1] = 0.0;
            rot[2] = 0.0;
            rot[0] = 1.0;
            rot[3] = 1.0;
            ...
            if (idx > PStore->size[2]) {
              emlrtDynamicBoundsCheckR2012b(idx, 1, PStore->size[2],
                                            &gb_emlrtBCI, (emlrtConstCTX)sp);
            }
            r1 = 4 * (idx - 1);
            PStore_data[r1] = 0.0;
            PStore_data[r1 + 1] = 0.0;
            PStore_data[r1 + 2] = 0.0;
            PStore_data[r1 + 3] = 0.0;
            r = _mm_loadu_pd(&rot[0]);
            b_r1 = _mm_loadu_pd(&PStore_data[r1]);
            _mm_storeu_pd(
                &PStore_data[r1],
                _mm_add_pd(b_r1,
            ...
            r = _mm_loadu_pd(&rot[0]);
            b_r1 = _mm_loadu_pd(&PStore_data[r1 + 2]);
            _mm_storeu_pd(
                &PStore_data[r1 + 2],
                _mm_add_pd(b_r1,
            ...
            st.site = &rc_emlrtRSI;
            regularize_cov_local(&st, &PStore_data[r1]);
            if (idx > WStore->size[1]) {
              emlrtDynamicBoundsCheckR2012b(idx, 1, WStore->size[1],
                                            &wb_emlrtBCI, (emlrtConstCTX)sp);
            }
            WStore_data[idx - 1] = missW;
            if (idx > maxComp) {
              emlrtDynamicBoundsCheckR2012b(idx, 1, maxComp, &xb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            parentIdx_data[idx - 1] = (int16_T)(i + 1);
            if (idx > maxComp) {
              emlrtDynamicBoundsCheckR2012b(idx, 1, maxComp, &yb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            measIdx_data[idx - 1] = (int8_T)(j + 1);
          }
          if (*emlrtBreakCheckR2012bFlagVar != 0) {
            emlrtBreakCheckR2012b((emlrtConstCTX)sp);
          }
    ...
    /*  ========================================================= */
    rawLike_i_size_idx_1 = inMap_size[1];
    r2 = inMap_size[1];
    memset(&rawLike_i_data[0], 0, (uint32_T)numIn * sizeof(real_T));
    memset(&bestWPerLandmark_data[0], 0, (uint32_T)numIn * sizeof(real_T));
    for (i = 0; i < idx; i++) {
      int16_T b_i;
      if (i + 1 > maxComp) {
        emlrtDynamicBoundsCheckR2012b(i + 1, 1, maxComp, &w_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      if (i + 1 > WStore->size[1]) {
        emlrtDynamicBoundsCheckR2012b(i + 1, 1, WStore->size[1], &x_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      b_i = parentIdx_data[i];
      if ((b_i < 1) || (b_i > r2)) {
        emlrtDynamicBoundsCheckR2012b(b_i, 1, r2, &qb_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      if (WStore_data[i] > bestWPerLandmark_data[b_i - 1]) {
        if (b_i > r2) {
          emlrtDynamicBoundsCheckR2012b(b_i, 1, r2, &rb_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        bestWPerLandmark_data[b_i - 1] = WStore_data[i];
        if (b_i > rawLike_i_size_idx_1) {
          emlrtDynamicBoundsCheckR2012b(b_i, 1, rawLike_i_size_idx_1,
                                        &sb_emlrtBCI, (emlrtConstCTX)sp);
        }
        rawLike_i_data[b_i - 1] = (real_T)i + 1.0;
      }
      if (*emlrtBreakCheckR2012bFlagVar != 0) {
        emlrtBreakCheckR2012b((emlrtConstCTX)sp);
      }
    ...
    for (i = 0; i < numIn; i++) {
      uint32_T u;
      if (i + 1 > rawLike_i_size_idx_1) {
        emlrtDynamicBoundsCheckR2012b(i + 1, 1, rawLike_i_size_idx_1,
                                      &y_emlrtBCI, (emlrtConstCTX)sp);
      }
      u = (uint32_T)rawLike_i_data[i];
      if (u > 0U) {
        outCount++;
        if ((int32_T)u > mStore->size[1]) {
          emlrtDynamicBoundsCheckR2012b((int32_T)u, 1, mStore->size[1],
        ...
        r1 = 2 * ((int32_T)u - 1);
        b_mapOut_data[outCount - 1].m[0] = mStore_data[r1];
        if (outCount > mapOut->size[1]) {
          emlrtDynamicBoundsCheckR2012b(outCount, 1, mapOut->size[1],
                                        &bc_emlrtBCI, (emlrtConstCTX)sp);
        }
        b_mapOut_data[outCount - 1].m[1] = mStore_data[r1 + 1];
        if ((int32_T)u > PStore->size[2]) {
          emlrtDynamicBoundsCheckR2012b((int32_T)u, 1, PStore->size[2],
        ...
        r1 = 4 * ((int32_T)u - 1);
        b_mapOut_data[outCount - 1].P[0] = PStore_data[r1];
        if (outCount > mapOut->size[1]) {
          emlrtDynamicBoundsCheckR2012b(outCount, 1, mapOut->size[1],
                                        &ac_emlrtBCI, (emlrtConstCTX)sp);
        }
        b_mapOut_data[outCount - 1].P[1] = PStore_data[r1 + 1];
        if (outCount > mapOut->size[1]) {
          emlrtDynamicBoundsCheckR2012b(outCount, 1, mapOut->size[1],
                                        &ac_emlrtBCI, (emlrtConstCTX)sp);
        }
        b_mapOut_data[outCount - 1].P[2] = PStore_data[r1 + 2];
        if (outCount > mapOut->size[1]) {
          emlrtDynamicBoundsCheckR2012b(outCount, 1, mapOut->size[1],
                                        &ac_emlrtBCI, (emlrtConstCTX)sp);
        }
        b_mapOut_data[outCount - 1].P[3] = PStore_data[r1 + 3];
        if ((int32_T)u > WStore->size[1]) {
          emlrtDynamicBoundsCheckR2012b((int32_T)u, 1, WStore->size[1],
        ...
        b_mapOut_data[outCount - 1].w = WStore_data[(int32_T)u - 1];
        if (((int32_T)u < 1) || ((int32_T)u > maxComp)) {
          emlrtDynamicBoundsCheckR2012b((int32_T)u, 1, maxComp, &db_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        r1 = measIdx_data[(int32_T)u - 1];
        r2 = birthIdx_size[1];
        if ((r1 < 1) || (r1 > r2)) {
          emlrtDynamicBoundsCheckR2012b(r1, 1, r2, &vb_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        birthIdx_data[r1 - 1] = false;
        /*  该量测被解释 */
      }
      if (*emlrtBreakCheckR2012bFlagVar != 0) {
        emlrtBreakCheckR2012b((emlrtConstCTX)sp);
    ...
    r1 = b_mapOut->size[1];
    mapOut->size[1] = b_mapOut->size[1];
    emxEnsureCapacity_struct0_T(sp, mapOut, r2, &q_emlrtRTEI);
    b_mapOut_data = mapOut->data;
    for (i = 0; i < r1; i++) {
      b_mapOut_data[i] = mapOut_data[i];
    }
                     ...
                     real_T iterCnt)
{
  ...
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  numMap = mapIn_size[1];
  emxInit_real_T(sp, &Xstore, 2, &hb_emlrtRTEI);
  emxInit_real_T(sp, &Pstore, 3, &ib_emlrtRTEI);
  emxInit_real_T(sp, &Wstore, 2, &jb_emlrtRTEI);
  emxInit_real_T(sp, &r, 2, &lb_emlrtRTEI);
  if (mapIn_size[1] != 0) {
    __m128d b_r2;
    __m128d r3;
    __m128d r4;
    ...
    emxEnsureCapacity_real_T(sp, Xstore, r1, &hb_emlrtRTEI);
    ...
    Pstore->size[1] = 3;
    Pstore->size[2] = maxComp;
    emxEnsureCapacity_real_T(sp, Pstore, r1, &ib_emlrtRTEI);
    Pstore_data = Pstore->data;
    r1 = 9 * maxComp;
    for (k = 0; k < r1; k++) {
      Pstore_data[k] = 0.0;
    ...
    Wstore->size[0] = 1;
    Wstore->size[1] = maxComp;
    emxEnsureCapacity_real_T(sp, Wstore, r1, &jb_emlrtRTEI);
    Wstore_data = Wstore->data;
    for (k = 0; k < maxComp; k++) {
      Wstore_data[k] = 0.0;
    }
    ...
    for (j = 0; j < i; j++) {
      ...
      for (c_i = 0; c_i < i1; c_i++) {
        ...
        real_T dx;
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &ve_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        dx = mapIn_data[c_i].m[0] - xBase[0];
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &we_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &ae_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (j + 1 > Rstack_size[2]) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, Rstack_size[2], &yd_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        K[K_tmp] -= K[r1] * a21;
        if (j + 1 > i) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, i, &be_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &de_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        dy = Z[0];
        a21 = Z[1];
        ...
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &te_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        for (k = 0; k < 3; k++) {
          r1 = 3 * k + 9 * c_i;
        ...
        if (j + 1 > i) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, i, &ce_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (c_i + 1 > numMap) {
        ...
        a21 = likelihood_local(&st, Zhat, &Z_data[2 * j], S) * params_P_D *
              mapIn_data[c_i].w;
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &df_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
      ...
      if (denom > 0.0) {
        for (b_i = 0; b_i < numMap; b_i++) {
          if (b_i + 1 > numMap) {
            emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, numMap, &af_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          if (a21 > params_PHD_det_keep) {
            idx++;
            if (b_i + 1 > numMap) {
              emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, numMap, &ee_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            ...
            if (b_i + 1 > numMap) {
              emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, numMap, &fe_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (idx > maxComp) {
              emlrtDynamicBoundsCheckR2012b(idx, 1, maxComp, &ie_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            for (k = 0; k < 3; k++) {
              K_tmp = 3 * k + 9 * b_i;
    ...
    for (b_i = 0; b_i < numMap; b_i++) {
      if (b_i + 1 > numMap) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, numMap, &xe_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      ...
      if (a21 > params_PHD_miss_keep) {
        idx++;
        if (idx > Xstore->size[1]) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, Xstore->size[1], &me_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        r1 = 3 * (idx - 1);
        ...
        if (idx > maxComp) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, maxComp, &je_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        for (k = 0; k < 3; k++) {
          r1 = 3 * k + 9 * (idx - 1);
        ...
        if (idx > Wstore->size[1]) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, Wstore->size[1], &ye_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        Wstore_data[idx - 1] = a21;
        sumW += a21;
    ...
    if (!(sumW <= 2.2204460492503131E-16)) {
      if (idx < 1) {
        ...
        if (idx > Wstore->size[1]) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, Wstore->size[1], &ge_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        K_tmp = idx;
        if (idx > Wstore->size[1]) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, Wstore->size[1], &he_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        i2 = idx;
      }
      ...
      r->size[0] = 1;
      r->size[1] = K_tmp;
      emxEnsureCapacity_real_T(sp, r, r1, &kb_emlrtRTEI);
      b_r1 = r->data;
      r1 = (K_tmp / 2) << 1;
      r2 = r1 - 2;
      for (k = 0; k <= r2; k += 2) {
      ...
      if (params_model == 1.0) {
        ...
        for (b_i = 0; b_i < idx; b_i++) {
          if (b_i + 1 > maxComp) {
            emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, maxComp, &ue_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          for (k = 0; k < 3; k++) {
            r1 = 3 * k + 9 * b_i;
        ...
        if (!(iterCnt != params_iter_max)) {
          ...
          for (k = 0; k < idx; k++) {
            ...
            if (k + 1 > maxComp) {
              emlrtDynamicBoundsCheckR2012b(k + 1, 1, maxComp, &se_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            a21 = Wstore_data[k];
            b_r2 = _mm_loadu_pd(&diff[0]);
                         ...
                         emxArray_struct0_T *mapOut)
{
  ...
  /*      mapOut = resize_map_local(mapOut, outCount); */
  /*  end */
  emxInit_struct0_T(sp, &pruned, &s_emlrtRTEI);
  emxInit_real_T(sp, &weights, 2, &db_emlrtRTEI);
  emxInit_struct0_T(sp, &merged, &w_emlrtRTEI);
  emxInit_real_T(sp, &mergedWeights, 2, &x_emlrtRTEI);
  emxInit_int32_T(sp, &members, 2, &bb_emlrtRTEI);
  emxInit_struct0_T(sp, &r, &eb_emlrtRTEI);
  if (mapIn->size[1] == 0) {
    mapOut->size[0] = 1;
    mapOut->size[1] = 0;
  } else {
    ...
    for (i = 0; i < b_r1; i++) {
      if (i + 1 > b_r1) {
        emlrtDynamicBoundsCheckR2012b(i + 1, 1, b_r1, &sc_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      if (mapIn_data[i].w > params_prune_threshold) {
        prunedCount++;
        if ((prunedCount < 1) || (prunedCount > loop_ub)) {
          emlrtDynamicBoundsCheckR2012b(prunedCount, 1, loop_ub, &md_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (i + 1 > b_r1) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, b_r1, &nd_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (i + 1 > b_r1) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, b_r1, &oc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (prunedCount > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(prunedCount, 1, loop_ub, &pc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (prunedCount > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(prunedCount, 1, loop_ub, &wc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
    ...
    if (prunedCount == 0) {
      ...
      if (prunedCount > r->size[1]) {
        emlrtDynamicBoundsCheckR2012b(prunedCount, 1, r->size[1], &fc_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      b_r1 = pruned->size[0] * pruned->size[1];
      pruned->size[1] = prunedCount;
      emxEnsureCapacity_struct0_T(sp, pruned, b_r1, &t_emlrtRTEI);
      pruned_data = pruned->data;
      b_r1 = weights->size[0] * weights->size[1];
      weights->size[0] = 1;
      weights->size[1] = prunedCount;
      emxEnsureCapacity_real_T(sp, weights, b_r1, &u_emlrtRTEI);
      weights_data = weights->data;
      for (i = 0; i < prunedCount; i++) {
        if (i + 1 > prunedCount) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, prunedCount, &tc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
      ...
      emxEnsureCapacity_struct0_T(sp, merged, b_r1, &w_emlrtRTEI);
      ...
      emxEnsureCapacity_real_T(sp, mergedWeights, b_r1, &x_emlrtRTEI);
      ...
      for (ii = 0; ii < prunedCount; ii++) {
        int32_T b_i;
        if (ii + 1 > b_loop_ub) {
          emlrtDynamicBoundsCheckR2012b(ii + 1, 1, b_loop_ub, &gc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        b_i = (int32_T)weights_data[ii];
        if ((b_i < 1) || (b_i > prunedCount)) {
          emlrtDynamicBoundsCheckR2012b(b_i, 1, prunedCount, &xc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (!used_data[b_i - 1]) {
          __m128d b_r2;
          ...
          int32_T memberCount;
          if (b_i > prunedCount) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, prunedCount, &yc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          emxEnsureCapacity_int32_T(sp, members, b_r1, &bb_emlrtRTEI);
          members_data = members->data;
          for (i = 0; i < prunedCount; i++) {
            members_data[i] = 0;
          }
          ...
          members_data[0] = b_i;
          if (b_i > prunedCount) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, prunedCount, &qc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          for (i = 0; i < memberCount; i++) {
            ...
            if ((b_r1 < 1) || (b_r1 > prunedCount)) {
              emlrtDynamicBoundsCheckR2012b(b_r1, 1, prunedCount, &jc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            b_r1 = members_data[i];
            if ((b_r1 < 1) || (b_r1 > prunedCount)) {
              emlrtDynamicBoundsCheckR2012b(b_r1, 1, prunedCount, &kc_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            b_r1 = members_data[i];
          ...
          if (mergedCount > mergedWeights->size[1]) {
            emlrtDynamicBoundsCheckR2012b(mergedCount, 1,
                                          mergedWeights->size[1], &gd_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
      ...
      if (mergedCount == 0) {
        ...
        if (mergedCount <= a21) {
          ...
          emxEnsureCapacity_struct0_T(sp, mapOut, b_r1, &ab_emlrtRTEI);
          ...
          if (mergedCount > mergedWeights->size[1]) {
            emlrtDynamicBoundsCheckR2012b(mergedCount, 1,
                                          mergedWeights->size[1], &nc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          st.site = &uc_emlrtRSI;
          b_r1 = weights->size[0] * weights->size[1];
          ...
          emxEnsureCapacity_real_T(&st, weights, b_r1, &y_emlrtRTEI);
          weights_data = weights->data;
          for (i = 0; i < mergedCount; i++) {
          ...
          emxEnsureCapacity_struct0_T(sp, mapOut, b_r1, &cb_emlrtRTEI);
          pruned_data = mapOut->data;
          for (i = 0; i < loop_ub; i++) {
            pruned_data[i] = r1[i];
          }
