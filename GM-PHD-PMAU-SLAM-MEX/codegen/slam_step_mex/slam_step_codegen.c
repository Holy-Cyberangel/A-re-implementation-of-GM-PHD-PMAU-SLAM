...
static emlrtRSInfo b_emlrtRSI = {
    ...
    "version\\codes\\GM-PHD-PMAU-SLAM-MEX\\tools\\slam_step_co"
    "degen.m" /* pathName */
};
            ...
            emxArray_struct0_T *mapOut)
{
  ...
  for (b_i = 0; b_i < i; b_i++) {
    if (b_i + 1 > i) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, i, &ed_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (b_i + 1 > mapOut->size[1]) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, mapOut->size[1], &fd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  for (j = 0; j < i1; j++) {
    if (j + 1 > birthIdx_size[1]) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, birthIdx_size[1], &gd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (birthIdx_data[j]) {
      __m128d r;
      ...
      outCount++;
      if (j + 1 > i1) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, i1, &bd_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      ...
      Jx[2] = 0.0;
      if (j + 1 > i1) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, i1, &hd_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      Jx[4] = Jx_tmp * S_tmp - d;
      Jx[1] = 0.0;
      Jx[3] = 1.0;
      if (j + 1 > i1) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, i1, &id_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
    ...
    boolean_T birthIdx_data[], int32_T birthIdx_size[2])
{
  ...
  for (i = 0; i < r2; i++) {
    if (i + 1 > r2) {
      emlrtDynamicBoundsCheckR2012b(i + 1, 1, r2, &ab_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (i + 1 > mapOut->size[1]) {
      emlrtDynamicBoundsCheckR2012b(i + 1, 1, mapOut->size[1], &bb_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  if (inMap_size[1] == 0) {
    ...
    for (j = 0; j < loop_ub; j++) {
      ...
      missW *= S_tmp;
      Zmap_data[r1] = x[1] + (-a21 * a22 + missW);
      if (j + 1 > loop_ub) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, loop_ub, &cb_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      Jx[4] = a22 * a21 - missW;
      if (j + 1 > loop_ub) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, loop_ub, &db_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
    ...
    for (j = 0; j < loop_ub; j++) {
      ...
      for (i = 0; i < numIn; i++) {
        ...
        st.site = &pc_emlrtRSI;
        if (i + 1 > numIn) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &q_emlrtBCI, &st);
        }
        if (j + 1 > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, loop_ub, &r_emlrtBCI, &st);
        }
        ...
        if (i + 1 > numIn) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &hb_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (i + 1 > numIn) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &ib_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        detDen += missW;
        if (*emlrtBreakCheckR2012bFlagVar != 0) {
      ...
      if (detDen > 0.0) {
        for (i = 0; i < numIn; i++) {
          if (i + 1 > numIn) {
            emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &gb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          if (missW > c_params_map_detection_add_thre) {
            int32_T b_i;
            if (i + 1 > numIn) {
              emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &s_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (j + 1 > loop_ub) {
              emlrtDynamicBoundsCheckR2012b(j + 1, 1, loop_ub, &t_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            r = _mm_loadu_pd(&Rworld_data[4 * j]);
            _mm_storeu_pd(&rot[0],
            ...
            st.site = &qc_emlrtRSI;
            if (i + 1 > numIn) {
              emlrtDynamicBoundsCheckR2012b(i + 1, 1, numIn, &u_emlrtBCI, &st);
            }
            b_st.site = &ib_emlrtRSI;
            ...
            b_i = r1 << 1;
            _mm_storeu_pd(&K[b_i], _mm_div_pd(_mm_loadu_pd(&inMap_data[i].P[0]),
                                              _mm_set1_pd(rot[r1])));
            ...
            r1 = birthIdx_size[1];
            if (j + 1 > r1) {
              emlrtDynamicBoundsCheckR2012b(j + 1, 1, r1, &lb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
  ...
  if (mapIn_size[1] != 0) {
    ...
    for (j = 0; j < i; j++) {
      ...
      for (c_i = 0; c_i < i1; c_i++) {
        ...
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &je_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &md_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (j + 1 > Rstack_size[2]) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, Rstack_size[2], &ld_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        K[K_tmp] -= K[r1] * a21;
        if (j + 1 > i) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, i, &nd_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &pd_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        dy = Z[0];
        a21 = Z[1];
        ...
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &ge_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        for (k = 0; k < 3; k++) {
          r1 = 3 * k + 9 * c_i;
        ...
        if (j + 1 > i) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, i, &od_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &oe_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        st.site = &bb_emlrtRSI;
        a21 = likelihood_local(&st, Zhat, &Z_data[2 * j], S) * params_P_D *
              mapIn_data[c_i].w;
        if (c_i + 1 > numMap) {
          emlrtDynamicBoundsCheckR2012b(c_i + 1, 1, numMap, &pe_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
      ...
      if (denom > 0.0) {
        for (b_i = 0; b_i < numMap; b_i++) {
          ...
          if (a21 > params_PHD_det_keep) {
            idx++;
            if (b_i + 1 > numMap) {
              emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, numMap, &qd_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            ...
            if (b_i + 1 > numMap) {
              emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, numMap, &rd_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (idx > maxComp) {
              emlrtDynamicBoundsCheckR2012b(idx, 1, maxComp, &ud_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            for (k = 0; k < 3; k++) {
              K_tmp = 3 * k + 9 * b_i;
    ...
    for (b_i = 0; b_i < numMap; b_i++) {
      if (b_i + 1 > numMap) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, numMap, &ke_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      ...
      if (a21 > params_PHD_miss_keep) {
        idx++;
        if (idx > Xstore->size[1]) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, Xstore->size[1], &yd_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        r1 = 3 * (idx - 1);
        ...
        if (idx > maxComp) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, maxComp, &vd_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        for (k = 0; k < 3; k++) {
          r1 = 3 * k + 9 * (idx - 1);
        ...
        if (idx > Wstore->size[1]) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, Wstore->size[1], &le_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        Wstore_data[idx - 1] = a21;
        sumW += a21;
    ...
    if (!(sumW <= 2.2204460492503131E-16)) {
      if (idx < 1) {
        ...
        if (idx > Wstore->size[1]) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, Wstore->size[1], &sd_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        K_tmp = idx;
        if (idx > Wstore->size[1]) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, Wstore->size[1], &td_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        i2 = idx;
      }
      ...
      if (params_model == 1.0) {
        ...
        for (b_i = 0; b_i < idx; b_i++) {
          if (b_i + 1 > maxComp) {
            emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, maxComp, &he_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          for (k = 0; k < 3; k++) {
            r1 = 3 * k + 9 * b_i;
        ...
        if (!(iterCnt != params_iter_max)) {
          ...
          for (k = 0; k < idx; k++) {
            ...
            if (k + 1 > maxComp) {
              emlrtDynamicBoundsCheckR2012b(k + 1, 1, maxComp, &fe_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            a21 = Wstore_data[k];
            b_r2 = _mm_loadu_pd(&diff[0]);
                         ...
                         emxArray_struct0_T *mapOut)
{
  ...
  if (mapIn->size[1] == 0) {
    ...
    for (i = 0; i < b_r1; i++) {
      if (i + 1 > b_r1) {
        emlrtDynamicBoundsCheckR2012b(i + 1, 1, b_r1, &fc_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      if (mapIn_data[i].w > params_prune_threshold) {
        prunedCount++;
        if ((prunedCount < 1) || (prunedCount > loop_ub)) {
          emlrtDynamicBoundsCheckR2012b(prunedCount, 1, loop_ub, &yc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (i + 1 > b_r1) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, b_r1, &ad_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (i + 1 > b_r1) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, b_r1, &bc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (prunedCount > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(prunedCount, 1, loop_ub, &cc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        ...
        if (i + 1 > b_r1) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, b_r1, &ic_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (prunedCount > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(prunedCount, 1, loop_ub, &jc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
    ...
    if (prunedCount == 0) {
      ...
      if (prunedCount > r->size[1]) {
        emlrtDynamicBoundsCheckR2012b(prunedCount, 1, r->size[1], &rb_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      b_r1 = pruned->size[0] * pruned->size[1];
      ...
      for (i = 0; i < prunedCount; i++) {
        if (i + 1 > prunedCount) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, prunedCount, &gc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
      ...
      for (ii = 0; ii < prunedCount; ii++) {
        int32_T b_i;
        if (ii + 1 > b_loop_ub) {
          emlrtDynamicBoundsCheckR2012b(ii + 1, 1, b_loop_ub, &sb_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        b_i = (int32_T)weights_data[ii];
        if ((b_i < 1) || (b_i > prunedCount)) {
          emlrtDynamicBoundsCheckR2012b(b_i, 1, prunedCount, &kc_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (!used_data[b_i - 1]) {
          __m128d b_r2;
          ...
          int32_T memberCount;
          if (b_i > prunedCount) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, prunedCount, &lc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          members_data[0] = b_i;
          if (b_i > prunedCount) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, prunedCount, &dc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          for (i = 0; i < memberCount; i++) {
            ...
            if ((b_r1 < 1) || (b_r1 > prunedCount)) {
              emlrtDynamicBoundsCheckR2012b(b_r1, 1, prunedCount, &vb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            b_r1 = members_data[i];
            if ((b_r1 < 1) || (b_r1 > prunedCount)) {
              emlrtDynamicBoundsCheckR2012b(b_r1, 1, prunedCount, &wb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            b_r1 = members_data[i];
          ...
          for (i = 0; i < memberCount; i++) {
            ...
            b_r1 = members_data[i];
            if ((b_r1 < 1) || (b_r1 > prunedCount)) {
              emlrtDynamicBoundsCheckR2012b(b_r1, 1, prunedCount, &yb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            b_r2 = _mm_loadu_pd(&diff[0]);
          ...
          if (mergedCount > mergedWeights->size[1]) {
            emlrtDynamicBoundsCheckR2012b(mergedCount, 1,
                                          mergedWeights->size[1], &sc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
      ...
      if (mergedCount == 0) {
        ...
        if (mergedCount <= a21) {
          ...
          if (mergedCount > mergedWeights->size[1]) {
            emlrtDynamicBoundsCheckR2012b(mergedCount, 1,
                                          mergedWeights->size[1], &ac_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          st.site = &uc_emlrtRSI;
          b_r1 = weights->size[0] * weights->size[1];
