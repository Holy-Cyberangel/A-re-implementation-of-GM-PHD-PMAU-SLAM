...
static boolean_T fb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                     const emlrtMsgIdentifier *msgId);
...
static boolean_T t_emlrt_marshallIn(const emlrtStack *sp,
...
static real_T *ab_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                   ...
                                   int32_T ret_size[2])
{
  static const int32_T dims[2] = {2, 48};
  real_T *ret_data;
...
static const mxArray *c_emlrt_marshallOut(const emxArray_struct0_T *u)
{
  ...
  static const char_T *sv[4] = {"m", "w", "P", "label"};
  const mxArray *b_y;
  const mxArray *c_y;
  const mxArray *d_y;
  const mxArray *e_y;
  ...
  for (b_j1 = 0; b_j1 < u->size[1U]; b_j1++) {
    ...
    pData = emlrtMxGetPr(m);
    pData[0] = u_data[b_j1].label[0];
    pData[1] = u_data[b_j1].label[1];
    emlrtAssign(&e_y, m);
    emlrtSetFieldR2017b(y, i, "label", e_y, 3);
    i++;
  }
  return y;
}
                               ...
                               int32_T y_size[2])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  l_emlrt_marshallIn(sp, emlrtAlias(nullptr), &thisId, y_data, y_size);
  emlrtDestroyArray(&nullptr);
}
                               ...
                               struct0_T y_data[], int32_T y_size[2])
{
  ...
  static const char_T *fieldNames[4] = {"m", "w", "P", "label"};
  emlrtMsgIdentifier thisId;
  int32_T i;
  boolean_T bv[2] = {false, true};
  ...
  for (i = 0; i < y_size[1]; i++) {
    ...
    m_emlrt_marshallIn(
        sp,
        emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, i, 3, "label")),
        &thisId, y_data[i].label);
  }
  emlrtDestroyArray(&u);
}
...
{
  static const int32_T dims = 0;
  static const char_T *fieldNames[36] = {"xn_dim",
                                         "xl_dim",
                                         "u_dim",
                                         "h_dim",
                                         "Qn",
  ...
  y->mon_carlo = n_emlrt_marshallIn(
      sp,
  ...
  y->GOSPA_p = n_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 32, "GOSPA_p")),
      &thisId);
  thisId.fIdentifier = "GOSPA_c";
  y->GOSPA_c = n_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 33, "GOSPA_c")),
      &thisId);
  thisId.fIdentifier = "model";
  y->model = n_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 34, "model")),
      &thisId);
  thisId.fIdentifier = "label_weight_gain";
  y->label_weight_gain =
      n_emlrt_marshallIn(sp,
                         emlrtAlias(emlrtGetFieldR2017b(
                             (emlrtConstCTX)sp, u, 0, 35, "label_weight_gain")),
                         &thisId);
  emlrtDestroyArray(&u);
}
                           ...
                           const mxArray *plhs[3])
{
  ...
  xPrev = c_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "xPrev");
  PPrev = e_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "PPrev");
  odom = g_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "odom");
  *(real_T **)&curMea_data =
      i_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "curMea", curMea_size);
  k_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "mapIn", mapIn_data,
                     mapIn_size);
  p_emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "params", &params);
  T = s_emlrt_marshallIn(&st, emlrtAliasP(prhs[6]), "T");
  isLastStep = t_emlrt_marshallIn(&st, emlrtAliasP(prhs[7]), "isLastStep");
  /* Invoke the target function */
  emxInit_struct0_T(&st, &mapOut, &db_emlrtRTEI);
