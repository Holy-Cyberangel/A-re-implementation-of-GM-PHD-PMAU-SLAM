...
% label related tuning: multiplier gain applied to detection likelihood
% effective multiplier = 1 + label_weight_gain * (label_count - 1)
params.label_weight_gain = 0.12;
